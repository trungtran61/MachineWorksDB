CREATE TABLE [dbo].[MWToolTransfer] (
    [mwLocation]      NVARCHAR (255) NULL,
    [mwName]          NVARCHAR (255) NULL,
    [mwMWID]          NVARCHAR (255) NULL,
    [mwComment]       NVARCHAR (255) NULL,
    [mwManufacturer]  NVARCHAR (255) NULL,
    [mwVendor]        NVARCHAR (255) NULL,
    [mwCode]          NVARCHAR (255) NULL,
    [mwRadius]        NVARCHAR (50)  NULL,
    [mwWidth]         NVARCHAR (255) NULL,
    [mwMaxDepthofCut] NVARCHAR (50)  NULL,
    [mwNumofCutter]   INT            NULL,
    [mwDiameter]      NVARCHAR (50)  NULL,
    [mwShankDia]      NVARCHAR (50)  NULL,
    [mwNumofFlutes]   INT            NULL,
    [mwFluteLength]   NVARCHAR (50)  NULL,
    [mwOAL]           NVARCHAR (50)  NULL,
    [mwDirection]     NVARCHAR (255) NULL,
    [mwAngle]         NVARCHAR (255) NULL,
    [mwChipBreaker]   NVARCHAR (255) NULL,
